...
extern uint8_t* GetRadioData();

extern uint8_t SendRadioData(uint8_t *data);

extern void InitRadio(uint8_t channel, uint8_t payload);

extern void SetRadioAddress(uint8_t *address);

extern void SetTransmitAddress(uint8_t *address);
